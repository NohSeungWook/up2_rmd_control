...
rmd_can::rmd_can()
{
    //0x89=a,0,c,2  0x77=b,1,d,3
    // spi1
    reference_msg[0].header = 0x89;     reference_msg[0].id = 0x141;    // left hip pitch
    reference_msg[1].header = 0x89;     reference_msg[1].id = 0x280;    // left knee pitch  **
    reference_msg[2].header = 0x77;     reference_msg[2].id = 0x143;    // right hip pitch
    reference_msg[3].header = 0x77;     reference_msg[3].id = 0x280;    // right knee pitch 

    reference_msg[4].header = 0x77;     reference_msg[4].id = 0x00;
    reference_msg[5].header = 0x77;     reference_msg[5].id = 0x00;     
    // spi2
    reference_msg[6].header = 0x89;     reference_msg[6].id = 0x141;    // left hip yaw      **
    reference_msg[7].header = 0x89;     reference_msg[7].id = 0x280;    // right hip yaw
    reference_msg[8].header = 0x77;     reference_msg[8].id = 0x143;    // left ankle pitch    **
    reference_msg[9].header = 0x77;     reference_msg[9].id = 0x144;    // right ankle pitch
